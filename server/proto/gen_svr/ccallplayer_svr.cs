...
/*this module code is codegen by abelkhan codegen for c#*/
    ...
    public class player_archive_set_level_rsp : Common.Response {
        private string _client_uuid_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c;
        private UInt64 uuid_deec1a87_f1ab_3f29_a633_985abf44f119;
        public player_archive_set_level_rsp(string client_uuid, UInt64 _uuid)
        {
            _client_uuid_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c = client_uuid;
            uuid_deec1a87_f1ab_3f29_a633_985abf44f119 = _uuid;
        }

        public void rsp(UserData info_391fd3d4_2d55_3f5e_9223_7f450a814a15){
            var _argv_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c = new ArrayList();
            _argv_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c.Add(uuid_deec1a87_f1ab_3f29_a633_985abf44f119);
            _argv_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c.Add(UserData.UserData_to_protcol(info_391fd3d4_2d55_3f5e_9223_7f450a814a15));
            Hub.Hub._gates.call_client(_client_uuid_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c, "player_archive_rsp_cb_set_level_rsp", _argv_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c);
        }

        public void err(Int32 err_ad2710a2_3dd2_3a8f_a4c8_a7ebbe1df696){
            var _argv_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c = new ArrayList();
            _argv_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c.Add(uuid_deec1a87_f1ab_3f29_a633_985abf44f119);
            _argv_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c.Add(err_ad2710a2_3dd2_3a8f_a4c8_a7ebbe1df696);
            Hub.Hub._gates.call_client(_client_uuid_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c, "player_archive_rsp_cb_set_level_err", _argv_677e440e_ec2f_3ed6_a6f7_ec55f2d6d32c);
        }
    ...
    public class player_archive_set_role_info_rsp : Common.Response {
        private string _client_uuid_79b44343_03d4_3f49_8253_d3a24f7c8da9;
        private UInt64 uuid_ef2ceff8_6540_3f62_b8bb_c3bce10490a2;
        public player_archive_set_role_info_rsp(string client_uuid, UInt64 _uuid)
        {
            _client_uuid_79b44343_03d4_3f49_8253_d3a24f7c8da9 = client_uuid;
            uuid_ef2ceff8_6540_3f62_b8bb_c3bce10490a2 = _uuid;
        }

        public void rsp(UserData info_391fd3d4_2d55_3f5e_9223_7f450a814a15){
            var _argv_79b44343_03d4_3f49_8253_d3a24f7c8da9 = new ArrayList();
            _argv_79b44343_03d4_3f49_8253_d3a24f7c8da9.Add(uuid_ef2ceff8_6540_3f62_b8bb_c3bce10490a2);
            _argv_79b44343_03d4_3f49_8253_d3a24f7c8da9.Add(UserData.UserData_to_protcol(info_391fd3d4_2d55_3f5e_9223_7f450a814a15));
            Hub.Hub._gates.call_client(_client_uuid_79b44343_03d4_3f49_8253_d3a24f7c8da9, "player_archive_rsp_cb_set_role_info_rsp", _argv_79b44343_03d4_3f49_8253_d3a24f7c8da9);
        }

        public void err(Int32 err_ad2710a2_3dd2_3a8f_a4c8_a7ebbe1df696){
            var _argv_79b44343_03d4_3f49_8253_d3a24f7c8da9 = new ArrayList();
            _argv_79b44343_03d4_3f49_8253_d3a24f7c8da9.Add(uuid_ef2ceff8_6540_3f62_b8bb_c3bce10490a2);
            _argv_79b44343_03d4_3f49_8253_d3a24f7c8da9.Add(err_ad2710a2_3dd2_3a8f_a4c8_a7ebbe1df696);
            Hub.Hub._gates.call_client(_client_uuid_79b44343_03d4_3f49_8253_d3a24f7c8da9, "player_archive_rsp_cb_set_role_info_err", _argv_79b44343_03d4_3f49_8253_d3a24f7c8da9);
        }
    ...
    public class player_archive_module : Common.IModule {
        public player_archive_module()
        {
            ...
            Hub.Hub._modules.add_mothed("player_archive_set_level", set_level);
            ...
            Hub.Hub._modules.add_mothed("player_archive_set_role_info", set_role_info);
        }
        ...
        public event Action<Int32> on_set_level;
        public void set_level(IList<MsgPack.MessagePackObject> inArray){
            var _cb_uuid = ((MsgPack.MessagePackObject)inArray[0]).AsUInt64();
            var _level = ((MsgPack.MessagePackObject)inArray[1]).AsInt32();
            rsp = new player_archive_set_level_rsp(Hub.Hub._gates.current_client_uuid, _cb_uuid);
            if (on_set_level != null){
                on_set_level(_level);
            }
            rsp = null;
        }
        ...
        public event Action<Role> on_set_role_info;
        public void set_role_info(IList<MsgPack.MessagePackObject> inArray){
            var _cb_uuid = ((MsgPack.MessagePackObject)inArray[0]).AsUInt64();
            var _info = Role.protcol_to_Role(((MsgPack.MessagePackObject)inArray[1]).AsDictionary());
            rsp = new player_archive_set_role_info_rsp(Hub.Hub._gates.current_client_uuid, _cb_uuid);
            if (on_set_role_info != null){
                on_set_role_info(_info);
            }
            rsp = null;
        }

...
namespace Player
{
    public class client_msg_handle
    {
        ...
        public client_msg_handle()
        {
            ...
            player_archive_Module.on_set_level += Player_archive_Module_on_set_level;
            ...
            player_archive_Module.on_set_role_info += Player_archive_Module_on_set_role_info;
        }

        private async void Player_archive_Module_on_set_role_info(Role info)
        {
            var rsp = player_archive_Module.rsp as player_archive_set_role_info_rsp;
            ...
            try
            {
                ...
                if (_avatar != null)
                {
                    ...
                    foreach (var role_info in _data.Data.info.RoleList)
                    {
                        if (role_info.RoleID == info.RoleID)
                        {
                            _data.Data.info.RoleList.Remove(role_info);
                        }
                    }
                    _data.Data.info.RoleList.Add(info);
        ...
        private async void Player_archive_Module_on_set_level(int level)
        {
            var rsp = player_archive_Module.rsp as player_archive_set_level_rsp;
            var uuid = Hub.Hub._gates.current_client_uuid;
            ...
            try
            {
                ...
                {
                    var _data = _avatar.get_clone_hosting_data<PlayerInfo>();
                    _data.Data.info.LevelNum= level;
                    _data.Data.CheckStrength();
                    rsp.rsp(_data.Data.info);
                    _data.write_back();
                }
